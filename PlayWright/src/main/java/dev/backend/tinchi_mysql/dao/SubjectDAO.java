package dev.backend.tinchi_mysql.dao;

import dev.backend.tinchi_mysql.entities.Subject;

import static dev.backend.tinchi_mysql.configuration.MySQLConnection.getConnection;
...
public class SubjectDAO {
    ...
    public boolean insertSubject(Subject subject) {
        ...
        try {
            ...
            pstmt.setDouble(4, subject.getAttendanceMark());
            pstmt.setDouble(5, subject.getMidExamMark1());
            pstmt.setDouble(6, subject.getMidExamMark2());
            pstmt.setDouble(7, subject.getMidExamMark3());
            pstmt.setDouble(8, subject.getFinalExamMark());
    ...
    public boolean updateSubject(Subject subject) {
        ...
        try {
            ...
            pstmt.setDouble(3, subject.getAttendanceMark());
            pstmt.setDouble(4, subject.getMidExamMark1());
            pstmt.setDouble(5, subject.getMidExamMark2());
            pstmt.setDouble(6, subject.getMidExamMark3());
            pstmt.setDouble(7, subject.getFinalExamMark());
