...
import dev.backend.tinchi_mysql.entities.Human;
import dev.backend.tinchi_mysql.entities.Lecturer;
import dev.backend.tinchi_mysql.entities.Student;
...
public class UserDAO {
    ...
    public boolean addScore(Student student, Subject subject) {
        ...
        try {
            PreparedStatement ps = conn.prepareStatement(sql);
            ps.setDouble(1, subject.getAttendanceMark());
            ps.setDouble(2, subject.getMidExamMark1());
            ps.setDouble(3, subject.getMidExamMark2());
            ps.setDouble(4, subject.getMidExamMark3());
            ps.setDouble(5, subject.getFinalExamMark());
